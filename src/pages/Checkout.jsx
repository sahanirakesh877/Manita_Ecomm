...
const Checkout = () => {
  ...
  <a href="#" className="text-2xl font-bold text-gray-800">Chutaro Auto Link</a>
...
<div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
  ...
  <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
    ...
    <button className="mt-4 mb-8 w-full rounded-md bg-red-400 px-6 py-2 font-medium text-white">Place Order</button>
  </div>
</div>
