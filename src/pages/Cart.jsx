...
const Cart = () => {
  ...
  <div className="mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex items-center justify-center">
      <h1 className="text-2xl font-semibold text-red-600">Your Cart Added Items</h1>
    </div>
    <div className="mx-auto mt-8 max-w-2xl md:mt-6">
      <div className="bg-white shadow">
        <div className="px-4 py-6 sm:px-8 sm:py-10">
          ...
          <Link to='/chekout'>
            <button type="button" className="group inline-flex w-full items-center justify-center rounded-md bg-red-400 px-6 py-2 text-lg font-semibold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-red-800">
              Checkout
          ...
          <Link to='/product'>
          <p className='text-md mt-3 text-blue-600 font-semibold'>Continue Shopping</p>
          </Link>
        </div>
      </div>
    </div>
